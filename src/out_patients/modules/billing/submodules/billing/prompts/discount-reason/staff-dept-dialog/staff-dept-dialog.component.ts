...
@Component({
  selector: "out-patients-billig-staff-dept-dialog",
  templateUrl: "./staff-dept-dialog.component.html",
  styleUrls: ["./staff-dept-dialog.component.scss"],
})
export class BillingStaffDeptDialogComponent implements OnInit {
  staffForm!: FormGroup;
  questions: any;
  selectedCode: any = "";
  staffDetail: any = [];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<BillingStaffDeptDialogComponent>
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.http
      ...
      .subscribe((res: any) => {
        ...
        this.questions[0].options = this.staffDependentTypeList.map(
          (l: any) => {
  ...
  submit() {
    console.log(this.selectedCode, "Submitted");
