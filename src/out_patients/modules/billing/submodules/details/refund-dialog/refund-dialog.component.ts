...
import {
  objdt,
  objtab_cancelbill,
  saveRefundforParticularBill,
} from "../../../../../core/models/saveRefundforParticularBill.Model";
import {
  billRefundforSingleItem,
  objDsSave,
} from "../../../../../core/models/billRefundforSingleItem.Model";
import {
  cancelVisitNumberinRefund,
  objVisitDataTable,
} from "../../../../../core/models/cancelVisitNumberinRefund.Model";
...
export class BillDetailsRefundDialogComponent implements OnInit {
  ...
  saveforparticularbilllist: saveRefundforParticularBill =
    new saveRefundforParticularBill();
  billrefundforsingleitem: billRefundforSingleItem =
    new billRefundforSingleItem();
  cancelVisitNumberinRefundList: cancelVisitNumberinRefund =
    new cancelVisitNumberinRefund();
  refundafteracklistforfull: refundbillafteracknowledgementforfull =
    new refundbillafteracknowledgementforfull();
  ...
  ngOnInit(): void {
    ...
    if (
      this.router.url.split("?")[0] == "/out-patient-billing/details/services"
    ) {
      this.simpleRefund = 1;
      this.AckRefund = 0;
    } else {
    ...
    var notcancelledlist =
      this.billDetailService.patientbilldetaillist.billDetialsForRefund_ServiceDetail.filter(
        (item: any) => {
    ...
    console.log(
      this.billDetailService.patientbilldetaillist
        .billDetialsForRefund_ServiceDetail.length
    );
    if (
      this.billDetailService.patientbilldetaillist
        .billDetialsForRefund_ServiceDetail.length ==
    ...
    console.log(
      "particular bill flag:",
      this.particularbillflag,
      "single item flag:",
      this.singleitemflag
    );
  ...
  ngAfterViewInit(): void {
    ...
    this.panform.patientidentityform.controls["panno"].valueChanges.subscribe(
      () => {
        if (
          this.panform.patientidentityform.controls["panno"].status == "VALID"
        ) {
  ...
  validationcheck() {
    ...
    //cheque
      ...
      if (
        this.dueform.value.chequemount != "" &&
        this.dueform.value.chequemount != undefined &&
        this.dueform.value.chequemount != null &&
        this.dueform.value.chequeno != "" &&
        this.dueform.value.chequeno != undefined &&
        this.dueform.value.chequeno != null &&
        this.dueform.value.chequeissuedate != "" &&
        this.dueform.value.chequeissuedate != undefined &&
        this.dueform.value.chequeissuedate != null &&
        this.dueform.value.chequevalidity != "" &&
        this.dueform.value.chequevalidity != undefined &&
        this.dueform.value.chequevalidity != null &&
        this.dueform.value.chequebankname != "" &&
        this.dueform.value.chequebankname != undefined &&
        this.dueform.value.chequebankname != null &&
        this.dueform.value.chequebranchname != "" &&
        this.dueform.value.chequebranchname != undefined &&
        this.dueform.value.chequebranchname != null
      ) {
        this.submitbtnflag = false;
      } else {
        this.submitbtnflag = true;
    ...
    //credit
      ...
      if (
        this.dueform.value.creditamount != "" &&
        this.dueform.value.creditamount != undefined &&
        this.dueform.value.creditamount != null &&
        this.dueform.value.creditcardtype != "" &&
        this.dueform.value.creditcardtype != undefined &&
        this.dueform.value.creditcardtype != null &&
        this.dueform.value.creditcardno != "" &&
        this.dueform.value.creditcardno != undefined &&
        this.dueform.value.creditcardno != null &&
        this.dueform.value.creditbatchno != "" &&
        this.dueform.value.creditbatchno != undefined &&
        this.dueform.value.creditbatchno != null
      ) {
        this.submitbtnflag = false;
      } else {
        this.submitbtnflag = true;
    ...
    //online
      ...
      if (
        this.dueform.value.onlineamount != "" &&
        this.dueform.value.onlineamount != undefined &&
        this.dueform.value.onlineamount != null &&
        this.dueform.value.onlinetransacid != "" &&
        this.dueform.value.onlinetransacid != undefined &&
        this.dueform.value.onlinetransacid != null &&
        this.dueform.value.onlinebookingid != "" &&
        this.dueform.value.onlinebookingid != undefined &&
        this.dueform.value.onlinebookingid != null
      ) {
        this.submitbtnflag = false;
      } else {
        this.submitbtnflag = true;
    ...
    //mobile
      ...
      if (
        this.dueform.value.mobileamount != "" &&
        this.dueform.value.mobileamount != undefined &&
        this.dueform.value.mobileamount != null &&
        this.dueform.value.mobiletransactionid != "" &&
        this.dueform.value.mobiletransactionid != undefined &&
        this.dueform.value.mobiletransactionid != null &&
        this.dueform.value.mobilemerchantid != "" &&
        this.dueform.value.mobilemerchantid != undefined &&
        this.dueform.value.mobilemerchantid != null
      ) {
        this.submitbtnflag = false;
      } else {
        this.submitbtnflag = true;
    ...
    //upi
      ...
      if (
        this.dueform.value.upiamount != "" &&
        this.dueform.value.upiamount != undefined &&
        this.dueform.value.upiamount != null &&
        this.dueform.value.upino != "" &&
        this.dueform.value.upino != undefined &&
        this.dueform.value.upino != null &&
        this.dueform.value.upibatchno != "" &&
        this.dueform.value.upibatchno != undefined &&
        this.dueform.value.upibatchno != null
      ) {
        this.submitbtnflag = false;
      } else {
        this.submitbtnflag = true;
  ...
  sendotpclick() {
    ...
    this.http
      .post(
        ApiConstants.sendotpoprefund,
        this.getPatientrefundotpdetailsRequestBody()
      )
      .pipe(takeUntil(this._destroying$))
      .subscribe(
        (resultData) => {
    ...
    if (this.mop == 1) {
      ...
      if (this.dueform.controls["chequevalidity"].value < new Date()) {
        this.messageDialogService.info(
          "Validity Date Can not be lesser then todays date"
        );
  ...
  submitbtncall() {
    ...
    if (this.dueform.controls["otp"].value.toString().length == 0) {
      ...
      this.dueform.controls["otp"].value.toString().length < 4 ||
      this.dueform.controls["otp"].value.toString().length > 4
    ) {
    ...
    if (this.simpleRefund == 1) {
      ...
      if (this.particularbillflag == 1 && this.singleitemflag == 0) {
        ...
        if (result.length == 1 && this.mop == 6) {
          if (result[0].amount == result[0].payTmAmtCheck) {
            this.messageDialogService.info(
              "Payment was made through multiple mop. Bill cannot be refunded through PayTM, Please refund through CASH"
            );
          }
        }
        ...
        this.http
          .post(
            BillDetailsApiConstants.saverefunddetailsforparticularbill,
            this.fullbillrequestbody()
          )
          .pipe(takeUntil(this._destroying$))
          .subscribe((res) => {
            console.log(res);
            if (res.length > 0) {
              if (res[0].successFlag == true) {
                ...
                var dialog = this.messageDialogService.success(
                  res[0].returnMessage
                );
                ...
                this.apiProcessing = false;
                var dialog = this.messageDialogService.info(
                  res[0].returnMessage
                );
              }
            }
            if (res[0].successFlag == true) {
              if (
                this.billDetailService.patientbilldetaillist
                  .billDetialsForRefund_VisitDetail.length > 0 &&
                this.cancelVisitNumberinRefundList.objVisitDataTable.length > 0
              ) {
                this.http
                  .post(
                    BillDetailsApiConstants.cancelvisitnumberinrefund,
                    this.cancelvisitrequestbody()
                  )
                  .pipe(takeUntil(this._destroying$))
                  .subscribe((value) => {
        ...
        this.http
          .post(
            BillDetailsApiConstants.billrefundforsingleitem,
            this.singlebillrequestbody()
          )
          .pipe(takeUntil(this._destroying$))
          .subscribe((res) => {
            console.log(res);
      ...
      if (this.particularbillflag == 1 && this.singleitemflag == 0) {
        ...
        this.http
          .post(
            BillDetailsApiConstants.refundbillafteracknowledgementforfull(
        ...
        this.http
          .post(
            BillDetailsApiConstants.billrefundforsingleitemafteracknowledgement,
            this.singlebillrequestbody()
          )
          .pipe(takeUntil(this._destroying$))
          .subscribe((res) => {
  ...
  getpaymentmode() {
    this.http
      .get(
        BillDetailsApiConstants.getpaymentmode(
          this.data.billno,
          this.cookie.get("StationId")
        )
      )
  ...
  fullbillrequestbody() {
    this.saveforparticularbilllist.objtab_cancelbill =
      [] as Array<objtab_cancelbill>;
    ...
    this.billDetailService.sendforapproval.forEach((item: any) => {
      ...
      this.saveforparticularbilllist.objtab_cancelbill.push({
        ...
        transMode:
          this.billDetailService.patientbilldetaillist
            .billDetialsForRefund_ServiceItemItemIDPriorityID.length > 0
            ? Number(
                this.billDetailService.patientbilldetaillist
                  .billDetialsForRefund_ServiceItemItemIDPriorityID[0]
                  .transportationMode
              )
            : 0,
        priority:
          this.billDetailService.patientbilldetaillist
            ...
            ? Number(
                this.billDetailService.patientbilldetaillist
                  .billDetialsForRefund_ServiceItemItemIDPriorityID[0].priority
              )
            : 0,
      });
      console.log(dtlist);
  ...
  singlebillrequestbody() {
    ...
    this.billrefundforsingleitem.objDsSave.objtab_cancelbill =
      [] as Array<objtab_cancelbill>;
    ...
    this.billDetailService.sendforapproval.forEach((item: any) => {
      ...
      this.billrefundforsingleitem.locationId = Number(
        this.cookie.get("HSPLocationId")
      );
      this.billrefundforsingleitem.operatorId = Number(
        this.cookie.get("UserId")
      );
      this.billrefundforsingleitem.stationId = Number(
        this.cookie.get("StationId")
      );
      this.billrefundforsingleitem.amount = this.billDetailService.totalrefund;
      this.billrefundforsingleitem.decDiscountAmount = Number(
        dtlist[0].discountamount
      );
  ...
  cancelvisitrequestbody() {
    ...
    console.log(dtlist);
    this.cancelVisitNumberinRefundList.objVisitDataTable =
      [] as Array<objVisitDataTable>;
    if (dtlist.length > 0) {
      this.billDetailService.patientbilldetaillist.billDetialsForRefund_VisitDetail.forEach(
        (item: any) => {
          this.cancelVisitNumberinRefundList.cancelReasonID = Number(
            this.data.reasonid
          );
          this.cancelVisitNumberinRefundList.operatorID = Number(
            this.cookie.get("UserId")
          );
          this.cancelVisitNumberinRefundList.locationId = Number(
            this.cookie.get("HSPLocationId")
          );
          this.cancelVisitNumberinRefundList.objVisitDataTable.push({
            ...
            deleted: 1,
            ssn: this.billDetailService.patientbilldetaillist
              .billDetialsForRefund_Table0[0].ssn,
            uhid: this.billDetailService.patientbilldetaillist
              .billDetialsForRefund_Table0[0].uhid,
            registrationno:
              this.billDetailService.patientbilldetaillist.billDetialsForRefund_Table0[0].uhid.split(
                "."
              )[1],
          });
        }
  ...
  fullbillafterackreqbody() {
    this.refundafteracklistforfull.objtab_cancelbill =
      [] as Array<objtab_cancelbill>;
    this.billDetailService.sendforapproval.forEach((item: any) => {
      console.log(item);
      var dtlist = this.billDetailService.serviceList.filter((i: any) => {
  ...
  paytmRefund() {
    ...
    if (this.mop == 6) {
      this.http
        .get(
          BillDetailsApiConstants.GetMachineDetails(
            1,
            Number(this.cookie.get("HSPLocationId")),
            Number(this.cookie.get("UserId"))
          )
        ...
        .subscribe((res) => {
          ...
          if (merchantKey == "" && merchantGUID == "") {
            this.messageDialogService.info(
              "PayTm is not activated for this Max Hospital Location"
            );
          }
          var result = this.getpaymentmode();
          if (result.length == 1) {
            ...
            if (merchantOrderID.length > 0) {
              var POSTDATA1 =
                ...
                ",'amount':" +
                String(1234) +
                ",'currencyCode':'INR',' merchantGuid':" +
                merchantGUID +
                ", 'merchantOrderId' :" +
                merchantOrderID +
                "},'ipAddress':'127.0.0.1','platformName':'PayTM', 'operationType':'REFUND_MONEY','channel':'POS','version':'1.0'}";
            }
          }
        });
    }
