...
export class DepositDialogComponent implements OnInit {
  ...
  //   console.log(event);
  //   if(event.index == 0){
  //     this.selectedTabvalue= "Cash";
  //   }
  //   else  if(event.index == 1){
  //     this.selectedTabvalue= "Cheque";
  //   }
  //   else  if(event.index == 2){
  //     this.selectedTabvalue= "Credit Card";
  //   }
  //   else  if(event.index == 3){
  //     this.selectedTabvalue= "Demand Draft";
  //   }
  //   else  if(event.index == 4){
  //     this.selectedTabvalue= "Mobile Payment";
  //   }
  //   else  if(event.index == 5){
  //     this.selectedTabvalue= "Online Payment";
  //   }
  //   else  if(event.index == 6){
  //     this.selectedTabvalue= "PayTM";
  //   }
  //   else  if(event.index == 7){
  //     this.selectedTabvalue= "UPI";
  //   }
