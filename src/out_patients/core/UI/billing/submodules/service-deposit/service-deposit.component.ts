...
import {
  DepositType,
  ServiceType,
} from "@core/types/PatientPersonalDetail.Interface";
  ...
  getDepositType() {
    this.http
      ...
      .subscribe((resultData: any) => {
        ...
        console.log(this.deposittypeList);
        console.log(defalutSelector);
        if (defalutSelector && Number(this.cookie.get("HSPLocationId")) != 69) {
          this.servicedepositForm.controls["deposithead"].setValue(
            defalutSelector.value
          );
        }
