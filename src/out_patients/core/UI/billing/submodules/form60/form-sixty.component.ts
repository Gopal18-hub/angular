...
export class FormSixtyComponent implements OnInit, AfterViewInit {
          ...
          this.http
            ...
            .subscribe(
              (resultData) => {
                ...
                this.messageDialogService.success("Form60 details have been successfully saved.");
  ...
  getPatientform60SubmitRequestBody(): savepatientform60detailsModel {  
    return (this.form60savedetails = new savepatientform60detailsModel(
      ...
      this.form60form.value.agriculturalincome == undefined ? 0 : Number(this.form60form.value.agriculturalincome),
      this.form60form.value.otherthanagriculturalincome == undefined ? 0 : Number(this.form60form.value.otherthanagriculturalincome),
