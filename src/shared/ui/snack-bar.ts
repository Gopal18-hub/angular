import { Injectable, Component, Inject, NgModule, ViewEncapsulation, ChangeDetectionStrategy, ElementRef } from '@angular/core';
...
export class MaxHealthSnackBar {
  constructor(public snackBarRef: MatSnackBarRef<MaxHealthSnackBar>, @Inject(MAT_SNACK_BAR_DATA) public data: any, private _elementRef: ElementRef<HTMLElement>) {
